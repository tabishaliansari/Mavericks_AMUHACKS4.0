...
user = "neo4j"
password = "aicardi_syndrome-triples"  # 🔒 Replace this with your actual Neo4j password
...
with open(r"../Information Extraction/diseases_triples/aicardi_syndrome-triples.json", "r", encoding="utf-8") as f:
    triples = json.load(f)
